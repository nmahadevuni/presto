        ...
        extends AbstractTestQueryFramework
{
    ...
    private void createTestTables()
    {
        ...
        javaQueryRunner.execute("INSERT INTO ice_table_partitioned VALUES(1, date('2022-04-09'))");
        javaQueryRunner.execute("INSERT INTO ice_table_partitioned VALUES(2, date('2022-03-18'))");

        javaQueryRunner.execute("DROP TABLE IF EXISTS ice_table");
        javaQueryRunner.execute("CREATE TABLE ice_table(c1 INT, ds DATE)");
        javaQueryRunner.execute("INSERT INTO ice_table VALUES(1, date('2022-04-09'))");
        javaQueryRunner.execute("INSERT INTO ice_table VALUES(2, date('2022-03-18'))");
    }
