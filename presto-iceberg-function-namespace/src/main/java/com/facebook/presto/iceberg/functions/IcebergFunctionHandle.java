...
public class IcebergFunctionHandle
        implements FunctionHandle
{
    private final Signature signature;

    @JsonCreator
    public IcebergFunctionHandle(@JsonProperty("signature") Signature signature)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        IcebergFunctionHandle that = (IcebergFunctionHandle) o;
